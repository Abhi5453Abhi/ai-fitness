    ...
    return (
        <div className="flex flex-col h-full p-6 bg-white text-[#192126]">
            ...
            <div className="flex items-center mb-6">
                ...
                <span className="mx-auto text-lg font-bold">Current Diet</span>
            ...
            >
                <h1 className="text-2xl font-black mb-6 tracking-tight">What do you usually eat?</h1>

                {/* Inputs */}
                <div className="space-y-5 mb-8">
                    <div>
                        <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block">Breakfast</label>
                        <div className="relative">
                            <Utensils className="absolute left-4 top-4 w-4 h-4 text-gray-400" />
                            <input
                                type="text"
                                placeholder="e.g. Paratha, Toast..."
                    ...
                    <div>
                        <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block">Lunch</label>
                        <div className="relative">
                            <Utensils className="absolute left-4 top-4 w-4 h-4 text-gray-400" />
                            <input
                                type="text"
                    ...
                    <div>
                        <label className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2 block">Dinner</label>
                        <div className="relative">
                            <Utensils className="absolute left-4 top-4 w-4 h-4 text-gray-400" />
                            <input
                                type="text"
                                placeholder="e.g. Salad, Khichdi..."
                                value={currentDinner}
                ...
                <div className="">
                    <h3 className="text-gray-400 font-bold uppercase tracking-wider text-xs mb-4">Habits</h3>
                    <div className="space-y-3">
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <span className={`font-bold text-sm ${junkFood ? 'text-red-900' : 'text-[#192126]'}`}>I eat junk food often</span>
                            </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <span className={`font-bold text-sm ${milkIntake ? 'text-blue-900' : 'text-[#192126]'}`}>I drink milk daily</span>
                            </div>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <span className={`font-bold text-sm ${!waterIntake ? 'text-orange-900' : 'text-[#192126]'}`}>I drink &lt; 2L water</span>
                            </div>
